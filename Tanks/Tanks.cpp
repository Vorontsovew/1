...
// Tanks.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTanksApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CTanksApp::OnAppAbout)
...
CTanksApp::CTanksApp() noexcept
{
	...
	SetAppID(_T("Tanks.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CTanksApp

CTanksApp theApp;


// Инициализация CTanksApp
...
// Обработчики сообщений CTanksApp
...
void CTanksApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CTanksApp

void CTanksApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTanksApp::LoadCustomState()
{
}

void CTanksApp::SaveCustomState()
{
}
